...
export type LLPRegistrationLandingProps = LLPLandingProps;

// 6 Accordion FAQs (adapted from the Indian LLP Act, 1932 framework)
const FAQ_ITEMS = [
  { q: 'What is a Limited Liability Partnership (LLP) in India?', a: 'An LLP is a separate legal entity governed by the Limited Liability Partnership Act, 2008. It combines operational flexibility with limited liability protection for its partners and is commonly used by professional firms, consultants, agencies, startups and service businesses.' },
  { q: 'How many partners are required to register an LLP?', a: 'A minimum of two partners is required to form an LLP, and at least two designated partners are required. At least one designated partner must satisfy the applicable residency requirement under Indian law.' },
  { q: 'What documents are generally required?', a: 'Typical documents include PAN and identity/address proof of partners, passport-size photographs, registered-office address proof, NOC from the property owner where applicable, and details required for DSC, DIN/DPIN and incorporation filing.' },
  { q: 'How long does LLP registration take?', a: 'The timeline depends on name approval, DSC readiness, document accuracy and MCA processing. With complete documents, incorporation can often be completed within several working days, subject to government processing.' },
  { q: 'Is an LLP suitable for startups and service businesses?', a: 'Yes. LLPs are commonly used by consultants, agencies, professional firms and businesses that want limited liability with relatively flexible internal management.' },
  { q: 'Does an LLP need annual compliance after registration?', a: 'Yes. LLPs have ongoing compliance obligations, including annual filings and tax returns, even where business activity is limited. The exact requirements depend on the LLP\'s financial and operational position.' }
]

// Related services cross-linking items — sourced from LLP-adjacent structures
const RELATED_SERVICES = [
  { title: 'LLP Annual Compliance', desc: 'Annual MCA filing and income-tax compliance support for registered LLPs.', img: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&auto=format&fit=crop&q=80', price: '₹7,999' },
  { title: 'Private Limited Company Registration', desc: 'Register a private limited company with MCA incorporation support.', img: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' },
  { title: 'One Person Company Registration', desc: 'Set up an OPC for eligible single-founder businesses in India.', img: 'https://images.unsplash.com/photo-1556761175-b413da4baf72?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' },
  { title: 'Partnership Firm Registration', desc: 'Register a traditional partnership firm with deed drafting and filing support.', img: 'https://images.unsplash.com/photo-1521791055366-0d553872125f?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' },
  { title: 'GST Registration', desc: 'Get GST registration support for eligible LLPs and businesses.', img: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=600&auto=format&fit=crop&q=80', price: '₹699' },
  { title: 'MSME Udyam Registration', desc: 'Udyam registration support for eligible LLPs and small businesses.', img: 'https://images.unsplash.com/photo-1556761175-4b46a572b786?w=600&auto=format&fit=crop&q=80', price: '₹499' },
  { title: 'Trademark Registration', desc: 'Protect your LLP name, logo and brand identity through trademark filing support.', img: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80', price: '₹1,499 + Govt. Feess' },
  { title: 'Company Address Change', desc: 'Update the registered office address with documentation and MCA filing support.', img: 'https://images.unsplash.com/photo-1497366811353-6870744d04b2?w=600&auto=format&fit=crop&q=80', price: '₹2,499' },
  { title: 'Winding Up LLP', desc: 'Get assistance for eligible LLP closure or strike-off documentation and filing.', img: 'https://images.unsplash.com/photo-1497366754035-f200968a6e72?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' }
]

export const LLPRegistrationLanding: React.FC<LLPRegistrationLandingProps> = ({
  onBackToHome,
  onSelectService,
  onOpenBrochure,
  onOpenAppointment
  ...
  const [businessType, setBusinessType] = useState('Limited Liability Partnership');
  const [businessActivity, setBusinessActivity] = useState(BUSINESS_ACTIVITIES[0]);
  const [panNumber, setPanNumber] = useState('');
  const [selectedPackage, setSelectedPackage] = useState('Limited Liability Partnership Package (₹2,999)');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">Limited Liability Partnership</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-xs font-semibold text-orange-300">
                  ...
                  <span>Pan-India LLP Registration Desk</span>
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  Limited Liability Partnership in India is the legal process of establishing a non-governmental organization for charitable, social-welfare, educational, healthcare, religious, or community-focused objectives. Depending on the chosen structure, an LLP may be registered as a Society, Trust, or Section 8 Company under applicable Indian laws.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>LLP Agreement Guidance</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>Dedicated LLP Consultant</span>
                  </div>
                </div>
              ...
              <div id="lead-capture-widget" className="lg:col-span-5 scroll-mt-24">
                <div className="bg-white rounded-2xl shadow-2xl border-2 border-orange-400/80 p-5 sm:p-6 text-slate-900 relative">
                  ...
                  <div className="absolute -top-3.5 right-6 px-3 py-1 rounded-full bg-[#FF5A00] text-[#0B3D91] text-xs font-black uppercase tracking-wider shadow-md flex items-center gap-1">
                    ...
                    <span>STARTUP-FRIENDLY PACKAGE</span>
                  </div>
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our Noida-based LLP registration specialist has been assigned to your LLP registration request. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select State of Limited Liability Partnership *
                              </label>
                              <select
                                value={selectedState}
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                Your registered state and partner details help us prepare the incorporation documents and MCA filing correctly.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              <div className="flex items-center gap-1.5 font-bold text-[#0B3D91]">
                                ...
                                <span>Why register your LLP with akshayb2bsolutions?</span>
                              </div>
                              <p className="text-[11px]">
                                Get LLP name approval support, partner KYC review, incorporation filing, agreement guidance and dedicated compliance assistance with minimal paperwork.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 2 && (
                          <div className="space-y-3 animate-in fade-in">
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Designated Partner / Applicant Name *
                              </label>
                              <input
                                type="text"
                                required
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Partner PAN Number (Optional for quote)
                              </label>
                              <input
                                type="text"
                                value={panNumber}
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select Limited Liability Partnership Package *
                              </label>
                              <select
                              ...
                              >
                                <option value="Limited Liability Partnership Package (₹2,999)">Limited Liability Partnership Package — ₹2,999 + Govt. Feess</option>
                              </select>
                            </div>
                          ...
                          {formStep < 3 ? (
                            ...
                            >
                              {isSubmitting ? (
                                ...
                                <>
                                  <span>Submit &amp; Start LLP Registration</span>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex items-center gap-1 sm:gap-2 overflow-x-auto py-2.5 no-scrollbar text-xs font-bold text-slate-600">
              {[
                ...
                { id: 'registration', label: 'LLP Registration' },
                ...
                { id: 'comparison', label: 'LLP vs Pvt Ltd' },
                { id: 'tax-implications', label: 'Tax & Compliance' },
                { id: 'financing', label: 'Best Use Cases' },
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              <span className="text-xs font-black uppercase tracking-wider text-[#0B3D91] bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
                Simple, Transparent LLP Registration
              </span>
              ...
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                One clear package for entrepreneurs and professionals who want an LLP with limited liability, flexible management and complete MCA incorporation support.
              </p>
            </div>
            ...
            <div className="max-w-[520px] mx-auto">
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-[#0D47A1]">LLP Registration Package</h3>
                  <p className="text-sm text-slate-500 mb-6">
                    Ideal for consultants, agencies, professional firms, startups and service businesses that want limited liability without the heavier structure of a private limited company.
                  </p>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      'LLP Name Approval Support',
                      'Partner KYC & DSC / DPIN Guidance',
                      'MCA / ROC Filing Support Support',
                      'LLP Incorporation Document Preparation',
                      'LLP Agreement & Post-Incorporation Guidance',
                      'Dedicated LLP Registration Specialist'
                    ].map((item, idx) => (
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('Limited Liability Partnership Package (₹2,999)');
                ...
                >
                  Get Started with LLP Registration Package
                </button>
              </div>
            </div>
          </div>
        ...
        <section id="overview" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              An LLP is a body corporate with a separate legal identity from its partners. It offers limited liability protection while allowing partners to manage the business through an LLP Agreement, making it popular among professional and service businesses.
            </p>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Ideal for consultants, agencies, accountants, legal professionals, technology firms, startups, family businesses and other service-oriented ventures seeking flexibility with limited liability.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  The LLP Agreement defines partner contribution, profit sharing, duties, management rights, admission or exit of partners and other internal rules.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  An LLP continues as a separate legal entity even when partners change, subject to applicable filings and compliance.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Partner liability is generally limited to the agreed contribution, although personal liability can arise in cases such as fraud or personal wrongdoing.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  LLPs combine partnership-style flexibility with corporate legal recognition, making them a practical option for many founder-led businesses.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, LLP registration provides a recognized legal framework for pursuing social and charitable objectives. Our team supports name selection, documentation, filing, government coordination, and post-registration guidance.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              <span className="text-xs font-black uppercase tracking-wider text-[#0B3D91] bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
                LLP Act & MCA Framework
              </span>
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How Limited Liability Partnership Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              LLP registration is the formal legal process of establishing a non-governmental organization in India. The application and documents vary according to whether the organization is registered as a Society, Trust, or Section 8 Company.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              After approval, the relevant authority issues the LLP registration certificate or incorporation document. This helps establish legal recognition and supports activities such as opening a bank account, entering agreements, applying for eligible grants, and building donor confidence.
            </p>
        ...
        <section id="advantages" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                { title: 'Limited Liability Protection', desc: 'Partners generally have liability limited to their agreed contribution, protecting personal assets from ordinary business liabilities.' },
                { title: 'Separate Legal Entity', desc: 'The LLP can own property, enter contracts and continue independently of changes in partners.' },
                { title: 'Flexible Internal Management', desc: 'Partners can structure roles, profit sharing and decision-making through the LLP Agreement.' },
                { title: 'Lower Compliance Than Many Companies', desc: 'LLPs can be simpler to manage than private limited companies while still offering a recognised legal structure.' },
                { title: 'Suitable for Professional & Service Firms', desc: 'Popular with consultants, agencies, professional firms and knowledge-based businesses.' },
                { title: 'Perpetual Succession', desc: 'The LLP can continue despite admission, retirement or change of partners, subject to legal compliance.' }
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Checklist Before LLP Registration
              </h2>
            </div>

            <div className="space-y-3">
              {[
                { title: 'Minimum Two Partners', desc: 'Keep details of at least two proposed partners and designated partners ready.' },
                { title: 'Choose a Unique LLP Name', desc: 'Select a distinctive name that does not conflict with existing company, LLP or trademark names.' },
                { title: 'Define Business Activity', desc: 'Clearly identify the main objects and services the LLP will undertake.' },
                { title: 'Decide Partner Contribution', desc: 'Agree on each partner\'s contribution amount and profit-sharing ratio.' },
                { title: 'Prepare Partner KYC', desc: 'Keep PAN, Aadhaar/passport, address proof and photographs ready for all partners.' },
                { title: 'Arrange Registered Office Proof', desc: 'Keep recent utility bill, ownership/rent proof and NOC where applicable.' },
                { title: 'Plan LLP Agreement Terms', desc: 'Decide roles, duties, decision rights, profit sharing and partner exit/admission terms.' },
                { title: 'Complete Pre-Filing Review', desc: 'Our team checks name, KYC and incorporation documents before MCA submission.' }
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Eligibility Criteria for Limited Liability Partnership
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              To register a LLP in India, there must be a minimum of two partners and a maximum of twenty. All partners must be competent to contract under the Indian Contract Act, meaning they are of sound mind, legally qualified, and above eighteen years of age.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Minimum Two, Maximum Twenty Partners',
                  desc: 'The minimum founders, members, trustees, or directors depend on the chosen LLP structure and applicable state or central law.'
                },
                {
                  title: 'Age and Legal Capacity',
                  desc: 'Founders, trustees, members, or directors must satisfy the eligibility and documentation requirements applicable to the selected LLP structure.'
                },
                {
                  title: 'Unique LLP Name Requirement',
                  desc: 'The LLP must have a unique name that does not infringe on existing trademarks or include prohibited or restricted words.'
                },
                {
                  title: 'Written LLP Deed',
                  desc: 'The appropriate MOA, Trust Deed, or Society Rules must clearly state the LLP objectives, governance structure, powers, duties, and operating rules.'
                },
                {
                  title: 'Principal Place of Business in India',
                  desc: 'The LLP must have a valid registered office address with acceptable address proof and NOC where required.'
                },
                {
                  title: 'Sector-Specific Regulations',
                  desc: 'Regulated sectors such as banking, insurance, and NBFC operations require corporate company status and cannot operate as a LLP.'
                },
                {
                  title: 'Pre-Registration Compliance Verification',
                  desc: 'akshayb2bsolutions validates each partner\'s identity, KYC credentials, and deed clauses to ensure 100% statutory eligibility before filing.'
                }
              ].map((item, idx) => (
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              To process your LLP registration smoothly, identity and address proofs of founders, trustees, members, or directors, registered-office proof, photographs, and the applicable governing documents are generally required. Documents can be collected digitally.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                {
                  title: 'Partners\' Identity Proof (PAN Cards)',
                  desc: 'Scanned copies of each partner\'s Permanent Account Number (PAN) card, which serves as the primary tax identifier.'
                },
                {
                  title: 'Partners\' Address Proof (Aadhaar Card / Voter ID)',
                ...
                },
                {
                  ...
                  desc: 'The applicable governing document signed/executed by the required founders, trustees, members, or directors, covering LLP objectives and governance rules.'
                },
                {
        ...
        <section id="steps" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Step-by-Step Limited Liability Partnership Process
              </h2>
            </div>
              ...
              {[
                {
                  ...
                  desc: 'We prepare the appropriate governing document detailing the LLP objectives, partners, governance, powers, duties, and operating rules.'
                },
                {
                  step: 'Step 2',
                  title: 'Collect Documents & KYC of All Partners',
                ...
                {
                  step: 'Step 3',
                  title: 'Choose & Verify a Unique LLP Name',
                  desc: 'Our team helps check the proposed LLP name against applicable naming requirements and obvious conflicts before filing.'
                },
                {
                  step: 'Step 4',
                  title: 'Submit Application to relevant registering authority',
                  desc: 'We file Form 1, the stamped LLP deed, and supporting documents with the state\'s relevant registering authority on your behalf.'
                },
                {
                  step: 'Step 5',
                  title: 'PAN / TAN Application Guidance & GST Registration',
                  desc: 'We apply for the LLP\'s PAN and, where turnover thresholds apply, complete GST registration for tax compliance.'
                },
                {
                  step: 'Step 6',
                  title: 'Certificate Dispatch & Bank Account Resolution Kit',
                  desc: 'Receive the LLP registration certificate/incorporation documents and governing-document copies, followed by guidance for opening the LLP bank account and completing applicable post-registration formalities.'
                }
              ].map((item, idx) => (
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  The legal personality of an LLP depends on its structure. A Section 8 Company has a separate corporate identity, while Society and Trust structures are governed by their respective laws and constitutive documents.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Post-registration compliance depends on the LLP structure and activities and may include annual returns, accounts, tax filings, renewal/updates, donor records, and other statutory reporting.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Offers speed, shared responsibility, and pooled resources, but registered firms still lack perpetual succession — the entity may dissolve upon a partner\'s exit, unless the deed states otherwise.
                </p>
              </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our legal advisors guide you on the appropriate LLP structure, governing documents, tax registrations, donor-related registrations, and ongoing compliance requirements.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="post-compliance" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              After registration, LLPs must adhere to ongoing compliance requirements to remain legally valid and avoid monetary penalties or interest charges.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Apply for a Permanent Account Number (PAN) in the LLP\'s name and, if applicable, register for Goods and Services Tax (GST).'
                },
                {
                  title: 'Current Bank Account Opening',
                  desc: 'Open a dedicated bank account in the registered LLP name with the required registration and KYC documents.'
                },
                {
                  title: 'Annual LLP Compliance & Tax Filing',
                  desc: 'File the LLP\'s annual tax return at the flat 30% corporate-style rate plus applicable surcharge and cess, along with audit if turnover exceeds limits.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Comply with labour laws, including Employees\' Provident Fund (EPF) and Employee State Insurance (ESI), if the LLP employs staff.'
                },
                {
                ...
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Tax treatment depends on LLP structure and applicable exemptions
                    </td>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                LLP Tax & Compliance Considerations
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              LLP tax treatment depends on the legal structure and eligibility for applicable exemptions. Eligible charitable organizations may apply for tax registrations and exemptions subject to the Income Tax Act and approval requirements.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Tax Treatment Depends on LLP Structure',
                  desc: 'Tax liability and exemptions depend on whether the LLP is a Trust, Society, or Section 8 Company and on applicable approvals and activities.'
                },
                {
                  title: 'Charitable Application of Income',
                  desc: 'Eligible LLPs must apply income according to their charitable objects and comply with the conditions attached to applicable tax exemptions.'
                },
                {
                  title: 'Deductible Remuneration & Interest',
                  desc: 'Remuneration and interest paid to working partners are taxable in the partner\'s hands but deductible for the LLP, subject to prescribed limits.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Eligible LLPs should maintain proper books, supporting records, annual accounts, and complete audits or filings required under their applicable law.'
                },
                {
                  title: 'akshayb2bsolutions Tax Planning Support',
                  desc: 'Our compliance team helps organize accounts, tax registrations, applicable exemptions, and statutory reporting in line with the LLP structure.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              LLPs generally rely on donations, grants, CSR funding, membership contributions, and other lawful funding sources rather than equity investment. Eligibility and approvals vary by activity and legal structure.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Eligible LLPs may receive donations, grants, and institutional support subject to applicable law, donor conditions, and required registrations.'
                },
                {
                  title: 'Commercial Business Loans & Overdraft Facilities',
                  desc: 'Depending on eligibility and banking requirements, LLPs may explore suitable institutional finance and banking facilities for permitted activities.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Equity-style venture capital is generally not the purpose of an LLP; organizations seeking commercial investment should evaluate a suitable for-profit structure separately.'
                },
                {
              ...
              {[
                {
                  ...
                  desc: 'We analyze your business model and recommend the precise deed clauses and registration combination tailored to your partners\' needs.'
                },
                {
                  title: 'Flawless Deed Drafting & Digital Verification',
                  desc: 'Our compliance specialists draft a legally sound LLP deed, rent agreements, and declarations to eliminate Registrar rejections.'
                },
                {
        ...
        <section className="py-14 bg-slate-50 border-b border-slate-200">
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Why Entrepreneurs Choose akshayb2bsolutions
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: 'Enterprise-grade 256-bit SSL encryption protecting your partners\' KYC, financial records, and business documentation.',
                  icon: Lock
                }
              ].map((item, idx) => {
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            ...
            <p className="text-xs sm:text-sm text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Join thousands of thriving Indian co-founders who launched their LLP with akshayb2bsolutions. Zero hidden charges, 100% digital filing, and guaranteed resolution support.
            </p>
            <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
              ...
              >
                Start LLP Registration at ₹1,499/-
              </button>
              <button
...
export const LLPLanding = LLPRegistrationLanding;
export default LLPLanding;
