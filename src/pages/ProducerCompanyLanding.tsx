...
export interface ProducerCompanyLandingProps {
  onBackToHome: () => void;
...
export type ProducerCompanyRegistrationLandingProps = ProducerCompanyLandingProps;

// 6 Accordion FAQs (adapted from the Indian Producer Company Act, 1932 framework)
const FAQ_ITEMS = [
  { q: 'What is a Producer Company in India?', a: 'A Producer Company is a company formed by eligible primary producers for activities connected with production, harvesting, procurement, grading, pooling, handling, marketing, selling, export of primary produce, or supply of goods and services to members. It combines a corporate structure with producer-focused objectives.' },
  { q: 'Who can form a Producer Company?', a: 'A Producer Company is generally formed by eligible producer members or producer institutions meeting the requirements under applicable company law. The exact member structure should be checked before filing.' },
  { q: 'What documents are generally required?', a: 'Typical documents include PAN, Aadhaar or other identity/address proof of proposed members and directors, photographs, registered-office proof, NOC where applicable, producer-related activity details, proposed company names, and incorporation documents required for MCA filing.' },
  { q: 'How long does Producer Company registration take?', a: 'The timeline depends on name approval, DSC readiness, document accuracy and MCA processing. With complete documents, incorporation can often be completed within several working days, subject to government processing.' },
  { q: 'Can a Producer Company help farmers access larger markets?', a: 'Yes. A Producer Company can help members aggregate produce, negotiate better, build a common brand, access institutional buyers, improve procurement and strengthen market linkages.' },
  { q: 'Does a Producer Company have annual compliance?', a: 'Yes. Producer Companies have ongoing corporate, accounting, tax and MCA compliance obligations similar to other companies, along with governance requirements applicable to their structure.' }
]

// Related services cross-linking items — sourced from Producer Company-adjacent structures
const RELATED_SERVICES = [
  { title: 'FPO Registration Support', desc: 'Get structured support for farmer producer organisation setup and related registration requirements.', img: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' },
  { title: 'MSME Udyam Registration', desc: 'Udyam registration support for eligible producer and agri-processing businesses.', img: 'https://images.unsplash.com/photo-1523742810063-24566f5c46d0?w=600&auto=format&fit=crop&q=80', price: '₹499' },
  { title: 'GST Registration', desc: 'GST registration support for eligible producer companies and agri-businesses.', img: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=600&auto=format&fit=crop&q=80', price: '₹699' },
  { title: 'Trademark Registration', desc: 'Protect your producer-company brand, product name and logo through trademark filing support.', img: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80', price: '₹1,499 + Govt. Feess' },
  { title: 'FSSAI Registration', desc: 'Food-business registration support for eligible producer companies handling or processing food products.', img: 'https://images.unsplash.com/photo-1498837167922-ddd27525d352?w=600&auto=format&fit=crop&q=80', price: '₹899' },
  { title: 'IEC Registration', desc: 'Import Export Code support for producer companies planning export or import activities.', img: 'https://images.unsplash.com/photo-1494412519320-aa613dfb7738?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' },
  { title: 'Private Limited Company Registration', desc: 'Register a standard private limited company for non-producer business models.', img: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' },
  { title: 'Company Annual Compliance', desc: 'Get MCA annual filing, accounting and statutory compliance support for registered companies.', img: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' },
  { title: 'Startup India Registration', desc: 'Startup India recognition support for eligible innovative agri and producer-led businesses.', img: 'https://images.unsplash.com/photo-1556761175-b413da4baf72?w=600&auto=format&fit=crop&q=80', price: 'Contact Us' }
]
...
export const ProducerCompanyLanding: React.FC<ProducerCompanyLandingProps> = ({
  ...
  const [businessType, setBusinessType] = useState('Producer Company');
  const [businessActivity, setBusinessActivity] = useState(BUSINESS_ACTIVITIES[0]);
  const [panNumber, setPanNumber] = useState('');
  const [selectedPackage, setSelectedPackage] = useState('Producer Company Registration Package (₹2,999)');
      ...
      <main className="flex-grow">
        ...
        <div className="bg-white border-b border-slate-200/80 py-3 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-medium">
            ...
            <span className="text-slate-900 font-bold">Producer Company Registration</span>
          </div>
        </div>
        {/* 2. HERO SECTION */}
        <section
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-xs font-semibold text-orange-300">
                  ...
                  <span>Pan-India Producer Company Desk</span>
                  <span className="w-1 h-1 rounded-full bg-white/60"></span>
                  <span className="text-white">Fast MCA Incorporation Support</span>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-0.5">
                    <p className="text-xl sm:text-2xl font-black text-orange-300 antialiased">
                      Start your Producer Company at just{' '}
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  Producer Company Registration in India is the legal process of establishing a non-governmental organization for charitable, social-welfare, educational, healthcare, religious, or community-focused objectives. Depending on the chosen structure, an Producer Company may be registered as a Society, Trust, or Section 8 Company under applicable Indian laws.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>Dedicated Company Consultant</span>
                  </div>
                </div>
              ...
              <div id="lead-capture-widget" className="lg:col-span-5 scroll-mt-24">
                <div className="bg-white rounded-2xl shadow-2xl border-2 border-orange-400/80 p-5 sm:p-6 text-slate-900 relative">
                  ...
                  <div className="absolute -top-3.5 right-6 px-3 py-1 rounded-full bg-[#FF5A00] text-[#0B3D91] text-xs font-black uppercase tracking-wider shadow-md flex items-center gap-1">
                    ...
                    <span>AGRI-BUSINESS STARTER PACKAGE</span>
                  </div>
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our Noida-based Producer Company specialist has been assigned to your Producer Company registration request. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select State of Producer Company Registration *
                              </label>
                              <select
                                value={selectedState}
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                Your registered-office state, producer-member structure and business activity help us prepare the incorporation filing correctly.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              <div className="flex items-center gap-1.5 font-bold text-[#0B3D91]">
                                ...
                                <span>Why register your Producer Company with akshayb2bsolutions?</span>
                              </div>
                              <p className="text-[11px]">
                                Get producer-company name approval support, member/director KYC review, MOA/AOA drafting, MCA incorporation filing and dedicated compliance assistance with minimal paperwork.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 2 && (
                          <div className="space-y-3 animate-in fade-in">
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Authorized Applicant / Proposed Director Name *
                              </label>
                              <input
                                type="text"
                                required
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select Producer Company Registration Package *
                              </label>
                              <select
                              ...
                              >
                                <option value="Producer Company Registration Package (₹2,999)">Producer Company Registration Package — ₹2,999 + Govt. Feess</option>
                              </select>
                            </div>
                          ...
                          {formStep < 3 ? (
                            ...
                            >
                              {isSubmitting ? (
                                ...
                                <>
                                  <span>Submit &amp; Start Producer Company Registration</span>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex items-center gap-1 sm:gap-2 overflow-x-auto py-2.5 no-scrollbar text-xs font-bold text-slate-600">
              {[
                ...
                { id: 'post-compliance', label: 'Post-Incorporation' },
                { id: 'comparison', label: 'Producer Co. vs Pvt Ltd' },
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              <span className="text-xs font-black uppercase tracking-wider text-[#0B3D91] bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
                Simple, Transparent Producer Company Support
              </span>
              ...
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                One focused package for producer groups that want a formal company structure for aggregation, branding, processing, market access and stronger business credibility.
              </p>
            </div>
            ...
            <div className="max-w-[520px] mx-auto">
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <div className="flex items-center justify-start flex-wrap gap-2 mb-4">
                    <span className="px-3 py-1 rounded bg-orange-100 text-orange-900 text-[10px] font-black uppercase tracking-wide">
                      PRODUCER COMPANY STARTER PACKAGE
                    </span>
                  ...
                  <h3 className="text-2xl font-bold text-[#0D47A1]">Producer Company Package</h3>
                  <p className="text-sm text-slate-500 mb-6">
                    Ideal for farmer groups, dairy producers, growers, artisans and other primary producers who want to organise commercially and access larger markets through a recognised company structure.
                  </p>

                  <div className="mb-6 pb-6 border-b border-slate-100">
                    <div className="flex items-baseline gap-3">
                      <span className="text-lg text-slate-400 line-through">₹7,999</span>
                      <span className="text-4xl font-extrabold text-[#0D47A1]">₹4,999</span>
                    </div>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      'Producer Company Name Approval Support',
                      'Member / Director KYC & DSC Guidance',
                      'MCA / ROC Filing Support Support',
                      'MCA Incorporation Filing Support',
                      'PAN / TAN & Post-Incorporation Guidance',
                      'Dedicated Producer Company Specialist'
                    ].map((item, idx) => (
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('Producer Company Registration Package (₹2,999)');
                ...
                >
                  Get Started with Producer Company Package
                </button>
              </div>
            </div>
          </div>
        ...
        <section id="overview" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              A Producer Company is a company created for eligible primary producers to collectively manage production-linked business activities such as procurement, aggregation, grading, processing, marketing, sale and related member services.
            </p>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Ideal for farmer groups, dairy producers, horticulture growers, fisheries groups, artisans and other producer communities seeking better scale, market access and business organisation.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  The MOA and AOA define producer-focused objects, shareholding, governance, member rights, board powers and operating rules.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  A Producer Company is a separate legal entity and can enter contracts, own assets, open bank accounts and operate independently of individual members.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Formal registration can improve credibility with banks, institutional buyers, government programmes, suppliers and commercial partners.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  The structure supports collective bargaining, common branding, aggregation and value addition so producer members can pursue stronger commercial opportunities.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, Producer Company registration provides a recognized legal framework for pursuing social and charitable objectives. Our team supports name selection, documentation, filing, government coordination, and post-registration guidance.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              <span className="text-xs font-black uppercase tracking-wider text-[#0B3D91] bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
                Companies Act & MCA Framework
              </span>
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How Producer Company Registration Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              Producer Company registration is the formal legal process of establishing a non-governmental organization in India. The application and documents vary according to whether the organization is registered as a Society, Trust, or Section 8 Company.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              After approval, the relevant authority issues the Producer Company registration certificate or incorporation document. This helps establish legal recognition and supports activities such as opening a bank account, entering agreements, applying for eligible grants, and building donor confidence.
            </p>
        ...
        <section id="advantages" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                { title: 'Collective Market Power', desc: 'Aggregate member produce and negotiate with buyers from a stronger commercial position.' },
                { title: 'Separate Legal Entity', desc: 'Operate through a recognised company structure that can enter contracts, own assets and maintain business continuity.' },
                { title: 'Better Access to Institutional Buyers', desc: 'A formal company structure can improve credibility with large buyers, processors, retailers and procurement agencies.' },
                { title: 'Common Branding & Value Addition', desc: 'Build a shared brand, grading, packaging, processing or marketing model around member produce.' },
                { title: 'Member-Focused Governance', desc: 'The structure is designed around producer participation and producer-linked business objectives.' },
                { title: 'Growth & Funding Readiness', desc: 'A structured company can be better positioned for bank finance, schemes, partnerships and expansion opportunities, subject to eligibility.' }
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Checklist Before Producer Company Registration
              </h2>
            </div>

            <div className="space-y-3">
              {[
                { title: 'Confirm Eligible Producer Members', desc: 'Identify proposed members who are genuinely connected with primary production or eligible producer activity.' },
                { title: 'Choose a Unique Company Name', desc: 'Select a name that is distinctive and suitable for MCA approval.' },
                { title: 'Define Producer Activities', desc: 'Clearly state whether the company will focus on aggregation, procurement, processing, marketing, dairy, horticulture, fisheries or other producer-linked activities.' },
                { title: 'Identify Proposed Directors', desc: 'Keep KYC and contact details of proposed directors ready for DSC and incorporation filing.' },
                { title: 'Plan Share Capital & Member Contribution', desc: 'Decide the initial capital structure and contribution pattern suitable for the producer group.' },
                { title: 'Arrange Registered Office Proof', desc: 'Keep recent utility bill, rent/ownership proof and NOC where applicable.' },
                { title: 'Prepare MOA & AOA Objects', desc: 'Producer-oriented business objects and governance clauses should be drafted carefully.' },
                { title: 'Complete Pre-Filing Review', desc: 'Our team checks name, KYC, office proof and incorporation documents before MCA submission.' }
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              To register a Producer Company in India, there must be a minimum of two producer members and a maximum of twenty. All producer members must be competent to contract under the Indian Contract Act, meaning they are of sound mind, legally qualified, and above eighteen years of age.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Minimum Two, Maximum Twenty Producer Members',
                  desc: 'The minimum founders, members, trustees, or directors depend on the chosen Producer Company structure and applicable state or central law.'
                },
                {
                  title: 'Age and Legal Capacity',
                  desc: 'Founders, trustees, members, or directors must satisfy the eligibility and documentation requirements applicable to the selected Producer Company structure.'
                },
                {
                  title: 'Unique Producer Company Name Requirement',
                  desc: 'The Producer Company must have a unique name that does not infringe on existing trademarks or include prohibited or restricted words.'
                },
                {
                  title: 'Written Producer Company Deed',
                  desc: 'The appropriate MOA, Trust Deed, or Society Rules must clearly state the Producer Company objectives, governance structure, powers, duties, and operating rules.'
                },
                {
                  title: 'Principal Place of Business in India',
                  desc: 'The Producer Company must have a valid registered office address with acceptable address proof and NOC where required.'
                },
                {
                  title: 'Sector-Specific Regulations',
                  desc: 'Regulated sectors such as banking, insurance, and NBFC operations require corporate company status and cannot operate as a Producer Company.'
                },
                {
                  title: 'Pre-Registration Compliance Verification',
                  desc: 'akshayb2bsolutions validates each producer member\'s identity, KYC credentials, and deed clauses to ensure 100% statutory eligibility before filing.'
                }
              ].map((item, idx) => (
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              To process your Producer Company registration smoothly, identity and address proofs of founders, trustees, members, or directors, registered-office proof, photographs, and the applicable governing documents are generally required. Documents can be collected digitally.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                { title: 'PAN of Proposed Members / Directors', desc: 'PAN details of proposed directors and members as applicable.' },
                { title: 'Identity & Address Proof', desc: 'Aadhaar, voter ID, passport, driving licence or other accepted proofs as applicable.' },
                { title: 'Passport-Size Photographs', desc: 'Recent photographs of proposed directors or authorised applicants.' },
                { title: 'Producer Activity Proof / Details', desc: 'Information or documents supporting the producer-related activity of the proposed member group, where required.' },
                { title: 'Registered Office Address Proof', desc: 'Recent utility bill and ownership/rent documentation for the proposed registered office.' },
                { title: 'NOC / Rent Agreement, If Applicable', desc: 'Owner NOC and rental documents where the premises are not owned by the company or promoters.' }
        ...
        <section id="steps" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="space-y-4">
              {[
                { step: 'Step 1', title: 'Share Member, Director & Activity Details', desc: 'Provide producer-member information, proposed directors, business activity, registered office and preferred names.' },
                { step: 'Step 2', title: 'DSC & Name Readiness', desc: 'We guide proposed directors on digital-signature requirements and check suitable company names.' },
                { step: 'Step 3', title: 'Draft Producer-Focused MOA & AOA', desc: 'The company objects and governance clauses are prepared around eligible producer activities.' },
                { step: 'Step 4', title: 'Prepare Incorporation Documents', desc: 'KYC, declarations, office proof and incorporation attachments are organised for filing.' },
                { step: 'Step 5', title: 'MCA Incorporation Filing', desc: 'The company incorporation application is submitted and tracked with the Registrar.' },
                { step: 'Step 6', title: 'Post-Incorporation Guidance', desc: 'After incorporation, we guide you on PAN/TAN, bank account, GST/FSSAI where applicable, and ongoing company compliance.' }
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  The legal personality of an Producer Company depends on its structure. A Section 8 Company has a separate corporate identity, while Society and Trust structures are governed by their respective laws and constitutive documents.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Post-registration compliance depends on the Producer Company structure and activities and may include annual returns, accounts, tax filings, renewal/updates, donor records, and other statutory reporting.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Offers speed, shared responsibility, and pooled resources, but registered firms still lack perpetual succession — the entity may dissolve upon a producer member\'s exit, unless the deed states otherwise.
                </p>
              </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our legal advisors guide you on the appropriate Producer Company structure, governing documents, tax registrations, donor-related registrations, and ongoing compliance requirements.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="post-compliance" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              After registration, Producer Companys must adhere to ongoing compliance requirements to remain legally valid and avoid monetary penalties or interest charges.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Apply for a Permanent Account Number (PAN) in the Producer Company\'s name and, if applicable, register for Goods and Services Tax (GST).'
                },
                {
                  title: 'Current Bank Account Opening',
                  desc: 'Open a dedicated bank account in the registered Producer Company name with the required registration and KYC documents.'
                },
                {
                  title: 'Annual Producer Company Compliance & Tax Filing',
                  desc: 'File the Producer Company\'s annual tax return at the flat 30% corporate-style rate plus applicable surcharge and cess, along with audit if turnover exceeds limits.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Comply with labour laws, including Employees\' Provident Fund (EPF) and Employee State Insurance (ESI), if the Producer Company employs staff.'
                },
                {
                ...
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-orange-800 border-r border-slate-200">
                      Indian Producer Company Act, 1932
                    </td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-orange-800 border-r border-slate-200">
                      2 to 20 Producer Members
                    </td>
                    <td className="p-3.5 border-r border-slate-200">1 Sole Owner</td>
                    <td className="p-3.5 border-r border-slate-200">2 or More Designated Producer Members</td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Tax treatment depends on Producer Company structure and applicable exemptions
                    </td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Consensus Among Producer Members
                    </td>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              Producer Company tax treatment depends on the legal structure and eligibility for applicable exemptions. Eligible charitable organizations may apply for tax registrations and exemptions subject to the Income Tax Act and approval requirements.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Tax Treatment Depends on Producer Company Structure',
                  desc: 'Tax liability and exemptions depend on whether the Producer Company is a Trust, Society, or Section 8 Company and on applicable approvals and activities.'
                },
                {
                  title: 'Charitable Application of Income',
                  desc: 'Eligible Producer Companys must apply income according to their charitable objects and comply with the conditions attached to applicable tax exemptions.'
                },
                {
                  title: 'Deductible Remuneration & Interest',
                  desc: 'Remuneration and interest paid to working producer members are taxable in the producer member\'s hands but deductible for the Producer Company, subject to prescribed limits.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Eligible Producer Companys should maintain proper books, supporting records, annual accounts, and complete audits or filings required under their applicable law.'
                },
                {
                  title: 'akshayb2bsolutions Tax Planning Support',
                  desc: 'Our compliance team helps organize accounts, tax registrations, applicable exemptions, and statutory reporting in line with the Producer Company structure.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Where a Producer Company Adds Value
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              Producer Companys generally rely on donations, grants, CSR funding, membership contributions, and other lawful funding sources rather than equity investment. Eligibility and approvals vary by activity and legal structure.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Eligible Producer Companys may receive donations, grants, and institutional support subject to applicable law, donor conditions, and required registrations.'
                },
                {
                  title: 'Commercial Business Loans & Overdraft Facilities',
                  desc: 'Depending on eligibility and banking requirements, Producer Companys may explore suitable institutional finance and banking facilities for permitted activities.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Equity-style venture capital is generally not the purpose of an Producer Company; organizations seeking commercial investment should evaluate a suitable for-profit structure separately.'
                },
                {
              ...
              {[
                {
                  ...
                  desc: 'We analyze your business model and recommend the precise deed clauses and registration combination tailored to your producer members\' needs.'
                },
                {
                  title: 'Flawless Deed Drafting & Digital Verification',
                  desc: 'Our compliance specialists draft a legally sound Producer Company deed, rent agreements, and declarations to eliminate Registrar rejections.'
                },
                {
                ...
                {
                  title: 'Dedicated Post-Incorporation Growth Advisory',
        ...
        <section className="py-14 bg-slate-50 border-b border-slate-200">
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Why Producer Groups Choose akshayb2bsolutions
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: 'Enterprise-grade 256-bit SSL encryption protecting your producer members\' KYC, financial records, and business documentation.',
                  icon: Lock
                }
              ].map((item, idx) => {
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            <span className="text-xs font-black uppercase tracking-widest text-[#FF5A00] bg-white/10 px-3 py-1 rounded-full border border-white/20">
              Turn Collective Production into Business Strength
            </span>
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white leading-tight">
              Register Your Producer Company with Confidence
            </h2>
            <p className="text-xs sm:text-sm text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Join thousands of thriving Indian co-founders who launched their Producer Company with akshayb2bsolutions. Zero hidden charges, 100% digital filing, and guaranteed resolution support.
            </p>
            <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
              ...
              >
                Start Producer Company at ₹4,999/-
              </button>
              <button
...
export const ProducerCompanyRegistrationLanding = ProducerCompanyLanding;
