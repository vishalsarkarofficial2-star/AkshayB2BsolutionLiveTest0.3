...
export interface PrivateLimitedLandingProps {
  onBackToHome: () => void;
...
export type PrivateLimitedCompanyLandingProps = PrivateLimitedLandingProps;

// 6 Accordion FAQs (adapted from the Indian company Act, 1932 framework)
const FAQ_ITEMS = [
  { q: 'What is a Private Limited Company in India?', a: 'A Private Limited Company is a company incorporated under the Companies Act, 2013 with a separate legal identity, limited liability for shareholders and a structured ownership framework. It is one of the most widely used business structures for startups, growing businesses and companies planning to raise investment.' },
  { q: 'How many directors and shareholders are required?', a: 'A Private Limited Company generally requires at least two directors and two shareholders. The same individuals may act as both directors and shareholders, subject to the applicable Companies Act requirements.' },
  { q: 'What is included in the ₹1,999 package?', a: 'The package includes professional incorporation assistance, name-application guidance, incorporation-document preparation, MCA filing support, PAN/TAN coordination and dedicated registration assistance. Applicable government fees, stamp duty and any third-party charges are additional and depend on authorized capital, state and filing requirements.' },
  { q: 'What documents are required for company registration?', a: 'Common documents include PAN and identity/address proofs of directors and shareholders, passport-size photographs, registered-office proof, utility bill, NOC from the property owner where applicable, and details of the proposed company name, business activity and shareholding.' },
  { q: 'How long does Private Limited Company registration take?', a: 'The timeline depends on name approval, document readiness, MCA processing and any resubmission requirements. A properly prepared application can usually move efficiently, but final approval is subject to the Registrar of Companies.' },
  { q: 'Does a Private Limited Company need annual compliance?', a: 'Yes. After incorporation, a Private Limited Company generally has ongoing MCA, accounting, tax and statutory compliance obligations, including annual filings and other event-based filings as applicable.' }
]
...
const RELATED_SERVICES = [
  {
    ...
    desc: 'Start a Limited Liability Partnership with flexible management, separate legal identity and professional MCA filing support.',
    img: 'https://images.unsplash.com/photo-1521791136064-7986c2920216?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'One Person Company',
    desc: 'Incorporate an OPC for a single promoter who wants a corporate structure with limited liability.',
    img: 'https://images.unsplash.com/photo-1556761175-b413da4baf72?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'Partnership Firm Registration',
    desc: 'Set up a traditional partnership structure with professionally drafted partnership documentation and registration support.',
    img: 'https://images.unsplash.com/photo-1552664730-d307ca884978?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'Startup India Registration',
    desc: 'Get assistance with DPIIT Startup recognition for eligible innovative and scalable businesses.',
  ...
  },
  {
    ...
    desc: 'Get GST registration assistance for eligible businesses with documentation and application support.',
    img: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'Trademark Registration',
    desc: 'Protect your company name, logo and brand identity with trademark filing assistance.',
    img: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'Pvt Ltd Annual Compliance',
    desc: 'Stay compliant with annual MCA, accounting and statutory filing requirements after incorporation.',
    img: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=600&auto=format&fit=crop&q=80',
    price: 'Get Quote'
  },
  {
    title: 'Company Address Change',
    desc: 'Update the registered office address of your company with professional MCA filing support.',
...
export const PrivateLimitedLanding: React.FC<PrivateLimitedLandingProps> = ({
  ...
  const [selectedPackage, setSelectedPackage] = useState('Private Limited Company Registration Package (₹1,999 + Govt. Feess)');
      ...
      <main className="flex-grow">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-xs font-semibold text-orange-300">
                  ...
                  <span>Pan-India Company Incorporation Desk</span>
                  <span className="w-1 h-1 rounded-full bg-white/60"></span>
                  <span className="text-white">MCA Incorporation Assistance</span>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-0.5">
                    <p className="text-xl sm:text-2xl font-black text-orange-300 antialiased">
                      Start Your Private Limited Company at{' '}
                    ...
                    <p className="text-xs sm:text-sm font-semibold text-blue-100 antialiased">
                      + Govt. Feess & Stamp Duty (as applicable)
                    </p>
                  </div>
                </div>
                ...
                <p className="text-sm sm:text-base text-slate-200 leading-relaxed font-normal">
                  Private Limited Company in India is the legal process of establishing a non-governmental organization for charitable, social-welfare, educational, healthcare, religious, or community-focused objectives. Depending on the chosen structure, an company may be registered as a Society, Trust, or Section 8 Company under applicable Indian laws.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>2+ Directors / Shareholders</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <FileSignature className="w-4 h-4 text-[#FF5A00] flex-shrink-0" />
                    <span>MOA & AOA Preparation</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    ...
                    <span>Dedicated Company Advisor</span>
                  </div>
                </div>
                  ...
                  {formSubmitted ? (
                    <div className="text-center py-8 space-y-4 animate-in fade-in">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed max-w-xs mx-auto">
                        Thank you <span className="font-bold">{applicantName}</span>. Our company incorporation specialist has been assigned to your registration request. We will call you within 15 minutes at <span className="font-bold">{applicantMobile}</span>.
                      </p>
                      <button
                        onClick={() => {
                        ...
                        <div>
                          <div className="flex items-center gap-1.5">
                            ...
                            <h3 className="text-base font-extrabold text-[#0B3D91]">
                              Online Company Registration Desk
                            </h3>
                          </div>
                      ...
                      <div className="bg-gradient-to-r from-orange-50 to-orange-50 border border-orange-300 rounded-xl p-3 mb-4 flex items-center justify-between shadow-xs">
                        ...
                        <div className="text-right">
                          ...
                          <span className="text-[10px] font-medium text-slate-500 block leading-tight">
                            (stamp duty & statutory fees as applicable)
                          </span>
                        </div>
                      </div>
                      ...
                      <form onSubmit={handleSubmitForm} className="space-y-4">
                          ...
                          <div className="space-y-3 animate-in fade-in">
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select State of Private Limited Company *
                              </label>
                              <select
                                value={selectedState}
                              ...
                              <span className="text-[11px] text-slate-500 mt-1 block">
                                The registered-office state can affect stamp duty and certain filing details for company incorporation.
                              </span>
                            </div>
                            ...
                            <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 text-xs text-slate-600 space-y-1">
                              <div className="flex items-center gap-1.5 font-bold text-[#0B3D91]">
                                ...
                                <span>Why incorporate with akshayb2bsolutions?</span>
                              </div>
                              <p className="text-[11px]">
                                Get name-application guidance, incorporation-document preparation, MCA filing support, PAN/TAN coordination and dedicated assistance in one streamlined process.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {formStep === 3 && (
                          <div className="space-y-3 animate-in fade-in">
                            ...
                            <div>
                              <label className="block text-xs font-bold text-slate-700 mb-1">
                                Select Private Limited Company Package *
                              </label>
                              <select
                              ...
                              >
                                <option value="Private Limited Company Package (₹1,999)">Private Limited Company Package — ₹1,999 + Govt. Feess</option>
                              </select>
                            </div>
                          ...
                          {formStep < 3 ? (
                            ...
                            >
                              {isSubmitting ? (
                                ...
                                <>
                                  <span>Submit &amp; Start Company Registration</span>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex items-center gap-1 sm:gap-2 overflow-x-auto py-2.5 no-scrollbar text-xs font-bold text-slate-600">
              {[
                ...
                { id: 'registration', label: 'Incorporation Process' },
                { id: 'advantages', label: 'Benefits' },
                { id: 'checklist', label: 'Checklist' },
                { id: 'eligibility', label: 'Eligibility' },
                { id: 'documents', label: 'Documents Required' },
                { id: 'steps', label: 'Steps' },
                { id: 'legal-status', label: 'Legal Structure' },
                { id: 'post-compliance', label: 'Post-Incorporation' },
                { id: 'comparison', label: 'Compare Structures' },
                { id: 'tax-implications', label: 'Tax & Compliance' },
                { id: 'financing', label: 'Funding & Growth' },
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-10">
              <span className="text-xs font-black uppercase tracking-wider text-[#0B3D91] bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
                Simple Company Registration Package
              </span>
              ...
              <p className="text-sm text-slate-500 mt-2 mx-auto max-w-2xl text-center">
                A focused incorporation package for founders who want professional MCA filing support, clear documentation guidance and dedicated assistance from start to incorporation.
              </p>
            </div>
            ...
            <div className="max-w-[520px] mx-auto">
              <div className="bg-white rounded-2xl border-t-4 border-t-[#FF6B00] border-l border-r border-b border-slate-200 p-6 sm:p-8 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-[#0D47A1]">Private Limited Company Package</h3>
                  <p className="text-sm text-slate-500 mb-6">
                    Ideal for startups, growing businesses, agencies, technology companies and founders who want a scalable corporate structure with limited liability.
                  </p>
                  ...
                  <div className="space-y-3.5 mb-8">
                    ...
                    {[
                      'Company Name & Incorporation Guidance',
                      'MOA & AOA Preparation Support',
                      'ROC / MCA Filing Support',
                      'Director & Shareholder Documentation Review',
                      'PAN / TAN & Incorporation Document Coordination',
                      'Dedicated Company Registration Specialist'
                    ].map((item, idx) => (
                ...
                <button
                  onClick={() => {
                    setSelectedPackage('Private Limited Company Package (₹1,999)');
                ...
                >
                  Get Started with Private Limited Company Package
                </button>
              </div>
            </div>
          </div>
        ...
        <section id="overview" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm sm:text-base leading-relaxed">
              A Private Limited Company is a separate legal entity incorporated under the Companies Act, 2013. It can own assets, enter contracts, raise capital and continue independently of changes in its shareholders or directors, subject to statutory compliance.
            </p>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div className="text-sm text-slate-700">
                  ...
                  Startups, technology businesses, agencies, manufacturers, service companies, e-commerce brands and businesses planning to scale, bring in investors or build long-term corporate credibility.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Separate Legal Entity:</strong>
                  The company has its own legal identity distinct from directors and shareholders and can own property, enter agreements and operate through its registered corporate structure.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Limited Liability:</strong>
                  Shareholder liability is generally limited to the unpaid amount on their shares, helping separate personal assets from normal company obligations, subject to law.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Investment-Friendly Structure:</strong>
                  Private Limited Companies are widely used by businesses that plan to issue shares, admit investors, structure ownership and build a scalable corporate framework.
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
                <div className="text-sm text-slate-700">
                  <strong className="text-slate-900 font-bold block mb-0.5">Higher Business Credibility:</strong>
                  A registered company can improve confidence with clients, banks, vendors, platforms, employees and business partners who prefer dealing with a formal corporate entity.
                </div>
              </div>
            </div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed pt-2">
              In summary, a Private Limited Company offers limited liability, structured ownership and a strong platform for growth. Our team supports incorporation documentation, MCA filing and post-incorporation guidance.
            </p>
          </div>
        </section>
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                How Private Limited Company Works in India
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              Private Limited Company incorporation is completed through the Ministry of Corporate Affairs under the Companies Act, 2013. The process includes proposed-name review, director/shareholder details, incorporation forms and preparation of the company’s constitutional documents.
            </p>

            <p className="text-slate-700 text-sm leading-relaxed">
              After successful approval by the Registrar of Companies, the company receives its Certificate of Incorporation and related registration details. PAN and TAN are generally integrated into the incorporation process, subject to MCA and tax-system processing.
            </p>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-2">
              <h4 className="text-xs font-bold uppercase tracking-wider text-[#0B3D91] flex items-center gap-1.5">
                ...
                <span>How akshayb2bsolutions Streamlines Your Incorporation:</span>
              </h4>
              <p className="text-xs text-slate-600 leading-relaxed">
                Our team helps organize promoter documents, proposed names, business objects, shareholding details, MOA/AOA inputs and MCA filing requirements to reduce avoidable resubmissions.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="advantages" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
              ...
              {[
                {
                  ...
                  desc: 'The company is legally distinct from its shareholders and directors and can own assets, sign contracts and conduct business in its own name.'
                },
                {
                  title: 'Limited Liability Protection',
                  desc: 'Shareholders generally enjoy limited liability, which creates a clearer separation between company obligations and personal assets, subject to applicable law.'
                },
                {
                  title: 'Structured Ownership',
                  desc: 'Shareholding creates a clear ownership structure that can be documented, transferred and expanded as the company grows.'
                },
                {
                  title: 'Higher Market Credibility',
                  desc: 'A corporate structure can improve credibility with clients, enterprise buyers, banks, investors, vendors and skilled employees.'
                },
                {
                  title: 'Easier Fund-Raising Structure',
                  desc: 'A Private Limited Company can issue shares and is commonly preferred for equity investment, subject to the Companies Act and applicable securities and tax rules.'
                },
                {
                  title: 'Perpetual Succession',
                  desc: 'The company can continue despite changes in directors or shareholders, giving the business a more stable long-term legal identity.'
                }
              ].map((item, idx) => (
            ...
            <p className="text-xs text-slate-500 text-center pt-2">
              akshayb2bsolutions helps founders complete incorporation correctly and understand the ongoing compliance responsibilities that come with a Private Limited Company.
            </p>
          </div>
        </section>
        ...
        <section id="checklist" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'Choose a Distinct Company Name',
                  desc: 'Shortlist distinctive names that comply with MCA naming rules and avoid obvious conflicts with existing companies and trademarks.'
                },
                {
                  title: 'Define Main Business Objects',
                  desc: 'Clearly identify the company’s proposed activities so suitable object clauses can be prepared for the incorporation documents.'
                },
                {
                  title: 'Finalize Shareholding & Directors',
                  desc: 'Agree in advance on each promoter / director\'s capital contribution and profit/loss sharing ratio to avoid disputes after registration.'
                },
                {
                  title: 'Prepare Director & Shareholder KYC',
                  desc: 'Ensure each promoter / director\'s PAN Card and Aadhaar Card details match identically and are linked to an active mobile number for OTP verification.'
                },
                {
                  title: 'Prepare Registered Office Proof',
                  desc: 'Keep a recent utility bill, ownership proof or rent/lease document and NOC from the property owner where applicable.'
                },
                {
                  title: 'Collect Founder Details & Define Structure',
                  desc: 'Define company objects, authorized capital, subscriber details and governance provisions required for the Memorandum and Articles of Association.'
                },
                {
                  title: 'Check Post-Incorporation Registrations',
                  desc: 'Depending on activity and turnover, the company may also need GST, Shops & Establishment, FSSAI, IEC, Professional Tax or other sector-specific registrations.'
                },
                {
                  title: 'akshayb2bsolutions Pre-Filing Review',
                  desc: 'Our team reviews names, KYC documents, office proof, shareholding and incorporation inputs before MCA submission to reduce avoidable errors.'
                }
              ].map((item, idx) => (
        ...
        <section id="eligibility" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              A Private Limited Company generally requires at least two directors and two shareholders. At least one director must satisfy the applicable Indian residency requirement under the Companies Act, and the proposed company must have a registered office address.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Minimum Two Directors & Two Shareholders',
                  desc: 'The same individuals may serve as both directors and shareholders, subject to the Companies Act and applicable eligibility requirements.'
                },
                {
                  title: 'Director Eligibility',
                  desc: 'Proposed directors should meet statutory eligibility requirements and provide valid KYC and contact information for incorporation.'
                },
                {
                  title: 'Unique Company Name',
                  desc: 'The proposed name should comply with MCA naming rules and should not be identical or too similar to existing company or protected names.'
                },
                {
                  title: 'MOA & AOA',
                  desc: 'The Memorandum of Association defines the company’s principal objects, while the Articles of Association set internal governance rules.'
                },
                {
                  title: 'Registered Office in India',
                  desc: 'The company must maintain a registered office in India and provide acceptable address proof and NOC where required.'
                },
                {
                  title: 'Sector-Specific Approvals',
                  desc: 'Certain activities such as finance, insurance, food, healthcare, import-export or regulated professional services may require additional approvals or registrations.'
                },
                {
                  title: 'Pre-Incorporation Verification',
                  desc: 'akshayb2bsolutions validates each promoter / director\'s identity, KYC credentials, and deed clauses to ensure 100% statutory eligibility before filing.'
                }
              ].map((item, idx) => (
        ...
        <section id="documents" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              The following documents are commonly required for Private Limited Company incorporation. Exact requirements can vary depending on the directors, shareholders, office arrangement and MCA filing situation.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Scanned copies of each promoter / director\'s Permanent Account Number (PAN) card, which serves as the primary tax identifier.'
                },
                {
                  title: 'Directors / Shareholders\' Address Proof (Aadhaar Card / Voter ID)',
                  desc: 'Aadhaar, Voter ID, Passport, Driving Licence, bank statement or other accepted address proof as applicable.'
                },
                {
                  title: 'Registered Office Address Proof',
                  desc: 'Recent utility bill and supporting ownership or occupancy document for the proposed registered office.'
                },
                {
                  title: 'NOC / Rent or Ownership Document',
                  desc: 'NOC from the owner and rent/lease agreement where applicable, or ownership proof for owned premises.'
                },
                {
                  title: 'MOA, AOA & Subscriber Details',
                  desc: 'Subscriber, shareholding and company-object details required for preparing the Memorandum and Articles of Association.'
                },
                {
                  title: 'akshayb2bsolutions Incorporation Document Support',
                  desc: 'Our team helps prepare incorporation inputs, MOA/AOA details, declarations and supporting documents according to MCA filing requirements.'
                }
              ].map((item, idx) => (
        ...
        <section id="steps" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Step-by-Step Private Limited Company Process
              </h2>
            </div>
              ...
              {[
                {
                  step: 'Step 1',
                  title: 'Collect Founder Details & Define Structure',
                  desc: 'We collect promoter details, proposed directors/shareholders, business activity, shareholding and registered-office information.'
                },
                {
                  step: 'Step 2',
                  title: 'Prepare KYC & Office Documents',
                  desc: 'Upload KYC documents of directors/shareholders and registered-office proof, NOC and supporting documents where applicable.'
                },
                {
                  step: 'Step 3',
                  title: 'Apply / Finalize Company Name',
                  desc: 'We review proposed names against MCA naming principles and prepare the incorporation application with suitable alternatives where required.'
                },
                {
                  step: 'Step 4',
                  title: 'Submit Application to Registrar of Companies',
                  desc: 'We file Form 1, the stamped company deed, and supporting documents with the state\'s Registrar of Companies on your behalf.'
                },
                {
                  step: 'Step 5',
                  title: 'PAN / TAN Application Guidance & GST Registration',
                  desc: 'We apply for the company\'s PAN and, where turnover thresholds apply, complete GST registration for tax compliance.'
                },
                {
                  step: 'Step 6',
                  title: 'Certificate of Incorporation & PAN/TAN',
                  desc: 'After approval, receive the Certificate of Incorporation and related registration details, followed by guidance on bank account opening and important post-incorporation steps.'
                }
              ].map((item, idx) => (
        ...
        <section id="legal-status" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Legal Status of a Private Limited Company
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  A Private Limited Company has a separate legal identity from its shareholders and directors. It can own assets, enter contracts, sue or be sued and continue through changes in ownership, subject to the Companies Act, 2013.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Post-registration compliance depends on the company structure and activities and may include annual returns, accounts, tax filings, renewal/updates, donor records, and other statutory reporting.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-1.5">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Offers speed, shared responsibility, and pooled resources, but registered firms still lack perpetual succession — the entity may dissolve upon a promoter / director\'s exit, unless the deed states otherwise.
                </p>
              </div>
            ...
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-xs text-slate-700 space-y-1">
              ...
              <p>
                Our compliance advisors guide you on post-incorporation requirements, annual filings, GST and other registrations, statutory records and event-based MCA filings.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="post-compliance" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              After incorporation, a Private Limited Company has ongoing compliance obligations. Timely accounting, tax filings, annual MCA filings and event-based filings help keep the company in good standing.
            </p>
            ...
            <div className="space-y-3">
              {[
                ...
                },
                {
                  ...
                  desc: 'Open a dedicated bank account in the registered company name with the required registration and KYC documents.'
                },
                {
                ...
                {
                  title: 'Report Changes to the Registrar of Companies',
              ...
              <table className="w-full text-left text-xs border-collapse min-w-[700px]">
                ...
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold text-orange-800 border-r border-slate-200">
                      2 to 20 Directors / Shareholders
                    </td>
                    <td className="p-3.5 border-r border-slate-200">1 Sole Owner</td>
                    <td className="p-3.5 border-r border-slate-200">2 or More Designated Directors / Shareholders</td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-orange-50/60 font-semibold border-r border-slate-200">
                      Consensus Among Directors / Shareholders
                    </td>
        ...
        <section id="tax-implications" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Tax & Compliance for a Private Limited Company
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              company tax treatment depends on the legal structure and eligibility for applicable exemptions. Eligible charitable organizations may apply for tax registrations and exemptions subject to the Income Tax Act and approval requirements.
            </p>

            <div className="space-y-3">
              {[
                {
                  title: 'Tax Treatment Depends on company Structure',
                  desc: 'Tax liability and exemptions depend on whether the company is a Trust, Society, or Section 8 Company and on applicable approvals and activities.'
                },
                {
                  title: 'Charitable Application of Income',
                  desc: 'Eligible companies must apply income according to their charitable objects and comply with the conditions attached to applicable tax exemptions.'
                },
                {
                  title: 'Deductible Remuneration & Interest',
                  desc: 'Remuneration and interest paid to working directors / shareholders are taxable in the promoter / director\'s hands but deductible for the company, subject to prescribed limits.'
                },
                {
                ...
                },
                {
                  ...
                  desc: 'Our compliance team helps organize accounts, tax registrations, applicable exemptions, and statutory reporting in line with the company structure.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
        ...
        <section id="financing" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-2">
                Funding & Growth Options for a Private Limited Company
              </h2>
            </div>

            <p className="text-slate-700 text-sm leading-relaxed">
              companies generally rely on donations, grants, CSR funding, membership contributions, and other lawful funding sources rather than equity investment. Eligibility and approvals vary by activity and legal structure.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Eligible companies may receive donations, grants, and institutional support subject to applicable law, donor conditions, and required registrations.'
                },
                {
        ...
        <section id="why-akshayb2b" className="py-14 bg-white border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="space-y-3">
              {[
                {
                  title: 'Founder & Structure Assessment',
                ...
                {
                  title: 'Accurate MCA Documentation',
                  desc: 'Our team prepares incorporation inputs, MOA/AOA details, declarations and supporting documentation with focus on filing accuracy.'
                },
                {
                  title: 'ROC / MCA Filing Follow-Up',
                  desc: 'We track the MCA application and support clarifications or resubmission requirements raised during processing.'
                },
                {
                  title: 'Post-Incorporation Starter Guidance',
                  desc: 'Get guidance for bank account opening, statutory records and important registrations after incorporation.'
                },
                {
                  title: 'Dedicated Post-Incorporation Guidance',
                  desc: 'Get practical guidance on annual compliance, GST, trademark, Startup India and other registrations relevant to your company.'
                }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
                  <CheckCircle2 className="w-5 h-5 text-[#0B3D91] flex-shrink-0 mt-0.5" />
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                {
                  title: 'Transparent ₹1,999 + Govt. Fees Package',
                  desc: 'Professional assistance starts at ₹1,999. Government fees, stamp duty and applicable third-party charges are separate and depend on capital, state and filing requirements.',
                  icon: Tag
                },
                {
                  title: 'Pan-India Founder Support',
                  desc: 'Online company-registration assistance designed for Indian founders, startups and growing businesses across states.',
                  icon: Users
                },
                {
                  title: 'Post-Incorporation Compliance Guidance',
                  desc: 'Get guidance on important MCA, tax and statutory compliance obligations after company incorporation.',
                  icon: Zap
                },
                {
        ...
        <section className="py-14 bg-gradient-to-r from-[#0B3D91] to-[#082a66] text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
            ...
            <p className="text-xs sm:text-sm text-slate-200 max-w-2xl mx-auto leading-relaxed">
              Join thousands of thriving Indian co-founders who launched their company with akshayb2bsolutions. Zero hidden charges, 100% digital filing, and guaranteed resolution support.
            </p>
...
export const PrivateLimitedCompanyLanding = PrivateLimitedLanding;
